        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services
                ...
                .AddMicrosoftIdentityWebApp(options =>
                {
                    ...
                    {
                        if (context.Failure is not OpenIdConnectProtocolException)
                        {
                            return Task.FromResult(0);
                        }
                ...
                .EnableTokenAcquisitionToCallDownstreamApi(options => { Configuration.Bind("AzureAd", options); }, GraphConstants.Scopes)
                // Add a GraphServiceClient via dependency injection
                .AddMicrosoftGraph(options => { options.Scopes = string.Join(' ', GraphConstants.Scopes); })
